...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/riot5758/permission/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/riot5758/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/riot5758/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/riot5758/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
UDPX="wget https://raw.githubusercontent.com/riot-wrtx/v5/main/ssh/udpx.sh && chmod +x udpx.sh && ./udpx.sh"
...
export sem=$( curl -s https://raw.githubusercontent.com/riot-wrtx/v5/main/versions)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
clear
figlet 'PRANTAS'
echo -e "${BIPurple} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BIPurple} │                  ${BIWhite}${UWhite}PRANTAS TUNNELING${NC}"
echo -e "${BIPurple} │"
...
echo -e "${BIPurple} │  ${BIPurple}[${BIWhite}04${BIPurple}] TROJAN  ${BIPurple}[${BIYellow}Menu${BIPurple}]${NC}"  "${BIPurple}  [${BIWhite}11${BIPurple}] BOT PANEL     ${BIPurple}[${BIYellow}Menu${BIPurple}]${NC}" "${BIPurple} │${NC}"
...
8) clear ; add-host ;;
9) clear ; running ;;
10) clear ; wget https://raw.githubusercontent.com/riot-wrtx/v5/main/udpx.sh && chmod +x udpx.sh && ./udpx.sh ;;
7) clear ; m-bot ;;
12) clear ; lock ;;
13) clear ; unlock ;;
14) clear ; wget -q https://raw.githubusercontent.com/riot-wrtx/v5/main/update.sh && chmod +x update.sh && ./update.sh ;;
0) clear ; menu ;;
x) exit ;;
