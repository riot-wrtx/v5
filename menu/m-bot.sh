#!/bin/bash
ipsaya=$(curl -s https://icanhazip.com)
data_server=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
date_list=$(date +"%Y-%m-%d" -d "$data_server")
data_ip="https://raw.githubusercontent.com/riot-wrtx/permission/main/ipmini"
checking_sc() {
    ...
    if [[ $date_list < $useexp ]]; then
        ...
        echo -e "     \033[0;36mTelegram${NC}:  https://t.me/masansor2"
        echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}"
        exit
    fi
}
...
cd /usr/bin
clear
wget https://raw.githubusercontent.com/riot-wrtx/v5/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/riot-wrtx/v5/main/bot/kyt.zip
unzip kyt.zip
...
wget -q -O /usr/bin/addtrgo "https://raw.githubusercontent.com/riot-wrtx/v5/main/xary/addtrgo.sh" && chmod +x /usr/bin/addtrgo

wget -q -O /usr/bin/deltrgo "https://raw.githubusercontent.com/riot-wrtx/v5/main/xray/deltrgo.sh" && chmod +x /usr/bin/deltrgo

wget -q -O /usr/bin/cektrgo "https://raw.githubusercontent.com/riot-wrtx/v5/main/xray/cektrgo.sh" && chmod +x /usr/bin/cektrgo

wget -q -O /usr/bin/renewtrgo "https://raw.githubusercontent.com/riot-wrtx/v5/main/xray/renewtrgo.sh" && chmod +x /usr/bin/renewtrgo
